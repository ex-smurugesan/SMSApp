package om.apps.sms.view.utils;
...
public class ADFUtils {
    ...
    public static String getMessageFromBundle(String bundleName, String key) {
        ...
        System.out.println("ctx.getViewRoot().getLocale()"+ctx.getViewRoot().getLocale());
        ResourceBundle rsBundle = ResourceBundle.getBundle(bundleName,ctx.getViewRoot().getLocale());
